  ...
  head: () => ({
    meta: [
      { title: "Pinewood Trails RV Park — Magnolia, TX | Home" },
      {
        name: "description",
        content:
          "Spacious RV sites, modern amenities, and the peace of the pines in Magnolia, Texas. Book your stay at Pinewood Trails RV Park.",
      },
    ],
  }),
  component: HomePage,
...
function HomePage() {
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative">
        <div className="relative h-[560px] md:h-[640px] overflow-hidden">
          ...
          >
            ...
            <img
              src={heroImg}
              alt="Pinewood Trails RV Park"
              className="absolute inset-0 h-full w-full object-cover"
            />
          </video>
          {/* Subtle darkening so text stays legible over the video */}
          <div className="absolute inset-0 bg-black/30" />
          {/* Gradient behind right-side text only */}
          <div className="absolute inset-y-0 right-0 w-full md:w-[55%] bg-gradient-to-l from-black/55 via-black/25 to-transparent" />
          <div className="relative mx-auto grid h-full max-w-[1400px] grid-cols-1 items-center gap-8 px-6 md:grid-cols-2 md:px-10">
            ...
            <div className="order-1 md:order-2 flex flex-col items-center md:items-end text-cream reveal">
              <h1 className="font-display text-5xl md:text-7xl font-bold leading-[1.05] drop-shadow-lg text-center md:text-right">
                Relax. Explore.
                <br />
                <span className="font-script text-6xl md:text-8xl font-medium text-accent drop-shadow-lg">
                  Stay Awhile.
                </span>
              </h1>
              <p className="mt-5 max-w-md text-lg text-cream drop-shadow-md text-center md:text-right">
                92 sites tucked beneath the East Texas pines. Full hookups, 50A/30A service, and
                friendly staff ready to welcome you.
              </p>
              <Link
                to="/amenities"
                className="mt-6 inline-flex items-center gap-2 rounded-xl bg-accent px-6 py-3 font-display font-semibold text-accent-foreground shadow-lg transition-all duration-300 hover:bg-accent/90 hover:-translate-y-0.5 hover:shadow-xl"
              >
      ...
      <section
        id="welcome"
        className="mx-auto max-w-[1400px] px-6 py-20 md:px-10 grid gap-12 lg:grid-cols-2 reveal"
      >
        <div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 sm:grid-cols-6">
            {amenities.map((a) => (
              ...
              >
                ...
                <span className="whitespace-pre-line text-sm font-semibold text-primary-deep">
                  {a.label}
                </span>
              </div>
            ))}
          ...
          <div className="mt-8 inline-flex items-center gap-3 rounded-full border border-accent/40 bg-card px-6 py-3 shadow-sm">
            ...
            <span className="font-script text-2xl text-primary-deep">
        ...
        <div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-[1fr_280px]">
            <div className="relative overflow-hidden rounded-2xl ring-2 ring-accent/30 shadow-lg">
              ...
              <Link
                to="/sites"
                className="absolute bottom-3 right-3 rounded-lg bg-cream/95 px-3 py-1.5 text-sm font-medium text-primary-deep shadow-md hover:bg-accent hover:text-accent-foreground transition"
              >
                View All Sites
              </Link>
            </div>
            <div className="flex flex-col gap-3">
              {sampleSites.map((s) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col justify-between py-1 pr-2">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="rounded bg-primary-deep px-1.5 py-0.5 text-xs font-bold text-cream">
                          {s.num}
                        </span>
                      ...
                      <div className="mt-1 flex items-center gap-1.5">
                        <span className="rounded-full bg-accent/20 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-primary-deep">
                          {s.type}
                        </span>
                      ...
                      <div className="mt-1 text-sm">
                        <span className="font-bold text-primary-deep">${s.price}</span>{" "}
                  ...
                  <Link
                    to="/book"
                    className="self-center rounded-lg bg-accent px-3 py-2 text-xs font-semibold uppercase tracking-wider text-accent-foreground shadow transition-all duration-300 hover:bg-primary-deep hover:text-cream hover:-translate-y-0.5"
                  >
                    View
                  </Link>
                </div>
      ...
      <section className="border-y border-accent/40 bg-gradient-to-r from-cream via-accent/10 to-cream">
        <div className="mx-auto grid max-w-[1400px] items-center gap-6 px-6 py-8 md:grid-cols-4 md:px-10">
          ...
          <InfoItem
            ...
            text="Book online or call — we're happy to help."
          />
          <Link
            to="/book"
            className="inline-flex items-center justify-center rounded-xl bg-accent px-6 py-3 font-display font-semibold text-accent-foreground shadow-md transition-all duration-300 hover:bg-primary-deep hover:text-cream hover:-translate-y-0.5 hover:shadow-xl"
          >
            Book Now
          </Link>
        </div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-10">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            ...
            <div className="rounded-2xl border-2 border-accent/30 bg-gradient-to-b from-cream to-accent/10 p-7 shadow-lg">
              ...
              <Link
                to="/contact"
                className="mt-4 inline-block text-sm font-semibold text-primary-deep underline-offset-4 hover:underline hover:text-accent transition"
              >
            ...
            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-accent/30 bg-primary-deep p-7 text-cream shadow-lg">
              ...
              <div className="border-y border-accent/40 my-2 text-center text-xs tracking-[0.4em] py-0.5 px-4 text-accent">
                RV PARK
              </div>
            ...
            <div className="rounded-2xl border-2 border-accent/30 bg-gradient-to-b from-cream to-accent/10 p-7 shadow-lg">
              ...
              <p className="text-sm text-foreground">
                19651 Pinewood Trails Dr., Magnolia, TX 77355 — minutes from Tomball shopping,
                dining, and easy access to the Sam Houston National Forest.
              </p>
              <img
                src={welcomeSign}
                alt="Welcome sign"
                className="mt-4 h-40 w-full rounded-xl object-cover shadow-md"
                loading="lazy"
              />
            </div>
          </div>
...
function InfoItem({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) {
  return (
    <div className="flex items-center gap-3">
      <span className="rounded-full bg-accent p-3 text-accent-foreground shadow-md transition-transform duration-300 hover:scale-110 [&>svg]:h-5 [&>svg]:w-5">
        {icon}
      </span>
      <div>
