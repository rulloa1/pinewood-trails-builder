  ...
  head: () => ({
    meta: [
      { title: "Contact — Pinewood Trails RV Park" },
      {
        name: "description",
        content:
          "Get in touch with Pinewood Trails RV Park in Magnolia, TX. Call, email, or send us a message.",
      },
    ],
  }),
...
function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <PageHero
        title="Contact Us"
        subtitle="We're here 7 days a week — give us a call or send a message."
        crumb="Contact Us"
      />
      ...
      <section className="mx-auto max-w-[1400px] grid gap-6 px-6 py-12 md:px-10 lg:grid-cols-[1fr_1.2fr_1fr]">
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          <div className="flex items-center gap-2 font-display tracking-[0.25em] text-primary">
            🌲 CONTACT INFORMATION
          </div>
          <div className="mt-6 space-y-6">
            ...
            <Info icon={<AlertCircle />} title="After-Hours Emergency">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                For emergencies after office hours, please call the number above.
              </p>
            </Info>
            <Info icon={<MapPin />} title="Pinewood Trails RV Park">
              <div>19651 Pinewood Trails Dr.</div>
              <div>Magnolia, TX 77355</div>
            </Info>
        ...
        <div className="space-y-4">
          <SideCard
            icon={<Car />}
            title="DIRECTIONS"
            lines={["Easy access off FM 1488.", "Just 5 miles north of Magnolia."]}
          />
          <SideCard
            icon={<Calendar />}
          ...
          <SideCard
            ...
            lines={["Our office is located on-site", "and happy to help!"]}
          />
          <div className="rounded-xl border-2 border-gold/60 bg-primary-deep p-5 text-cream shadow">
            <div className="text-center font-display tracking-[0.2em]">
              🌲 PARK RULES REMINDER 🌲
            </div>
            ...
            <div className="mt-3 text-center font-script text-base">
...
function Info({
  ...
  return (
    <div className="flex gap-3">
      <span className="mt-0.5 rounded-full bg-primary p-2.5 text-primary-foreground [&>svg]:h-4 [&>svg]:w-4">
        {icon}
      </span>
      <div>
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border border-border bg-card p-5 shadow-sm">
      <div className="flex items-center gap-3">
        <span className="rounded-full bg-primary/10 p-3 text-primary [&>svg]:h-5 [&>svg]:w-5">
          {icon}
        </span>
        <div>
